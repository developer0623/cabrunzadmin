...
// Route::post('/user/updateclientlocation', 'WalkerController@walker_location');

Route::post('/user/login', 'OwnerController@login');

Route::post('/user/register', 'OwnerController@register');

Route::post('/user/resend_otp' , 'OwnerController@resend_otp');

Route::post('/user/verify_otp' , 'OwnerController@verify_otp');
...
Route::post('/user/fav_address','OwnerController@fav_address');

Route::post('/user/list_fav_address','OwnerController@list_fav_address');

Route::post('/user/delete_fav_address','OwnerController@delete_fav_address');

Route::post('/user/get_walk_complete_amount' , 'OwnerController@get_walk_complete_amount');

Route::post('/user/walk_complete_pay' , 'OwnerController@walk_complete_pay');
...
Route::post('/user/friend_request', 'OwnerController@friend_request');

Route::post('/user/accept_reject_friends', 'OwnerController@accept_reject_friend');
...
Route::post('/user/cancelRequests', 'DogController@cancelRequests');
...
Route::get('/server/schedulerequestday', 'DogController@schedule_request_day');

Route::get('/server/cron_friend', 'DogController@cron_friend');

Route::get('/server/schedulerequestlater', 'DogController@requestLater');

Route::post('/user/create_recurring', 'OwnerController@create_recurring');


Route::get('/server/schedulerecurring', 'DogController@scheduling_recurring');
...
Route::post('/user/walkpaymentaccept','DogController@walk_payment_accept');

Route::post('/user/search_user', 'OwnerController@search_user');

Route::post('/user/request_send_friend','OwnerController@request_send_friend');

Route::post('/user/reject_pay_request','OwnerController@reject_pay_request');

Route::post('/user/accept_pay_request','OwnerController@accept_pay_request');

Route::post('/user/check_friend_payment' , 'OwnerController@check_friend_payment');

Route::get('/user/friend_request', 'OwnerController@friend_request');
...
Route::get('/user/show_req_later', 'OwnerController@show_req_later');

Route::get('/user/show_recurring', 'OwnerController@show_recurring');
...
Route::get('/provider/show_req_later', 'WalkerController@show_req_later');
// Walker APIs

Route::get('/provider/getrequests', 'WalkerController@get_requests');

Route::get('/provider/getclientlocation', 'WalkerController@get_clientlocation');
...
Route::post('/provider/requestwalkreached', 'WalkerController@request_walk_reached');

Route::post('/provider/requestwalkeditamount', 'WalkerController@request_walk_edit_amount');

Route::post('/provider/requestwalkagreeamount', 'WalkerController@request_walk_agree_amount');
...
Route::get('/admin/cheking', array('as' => 'AdminSmsCheck', 'uses' => 'AdminController@cheking'));
...
Route::get('/admin/reviews/delete_walker/{id}', array('as' => 'AdminReviewsDeleteWalker', 'uses' => 'AdminController@delete_review_walker'));

Route::get('/admin/reviews/delete_client/{id}', array('as' => 'AdminReviewsDeleteClient', 'uses' => 'AdminController@delete_review_client'));
...
Route::post('/admin/edit_admins/update', array('as' => 'AdminSaveEditAdmin', 'uses' => 'AdminController@save_edit_admin'));
...
Route::get('/admin/user/sms/{id}', array('as' => 'AdminUserSms', 'uses' => 'AdminController@owner_sms'));

Route::post('/admin/user/sms', array('as' => 'AdminAddUserSms', 'uses' => 'AdminController@add_owner_sms'));
...
Route::get('/admin/admin_roles', array('as' => 'AdminRoles', 'uses' => 'AdminController@roles'));

Route::get('/admin/add_admin_roles', array('as' => 'AddingRoles', 'uses' => 'AdminController@add_role'));

Route::post('/admin/role_saving', array('as' => 'AdminRoleAdding', 'uses' => 'AdminController@role_saving'));

Route::get('/admin/delete_roles/{id}', array('as' => 'DeleteRoles', 'uses' => 'AdminController@delete_roles'));

Route::get('/admin/edit_roles/{id}', array('as' => 'EditRoles', 'uses' => 'AdminController@edit_roles'));

Route::post('/admin/save_edit_roles/{id}', array('as' => 'SaveEditRoles', 'uses' => 'AdminController@save_edit_roles'));

Route::get('/admin/manual_assign', array('as' => 'AdminManualAssign', 'uses' => 'AdminController@manual_assign'));

Route::get('/admin/advance_trips', array('as' => 'AdminManualAssign', 'uses' => 'AdminController@advance_trips'));



Route::get('/admin/provider/banking/{id}', array('as' => 'AdminProviderBanking', 'uses' => 'AdminController@banking_provider'));

Route::get('/admin/request/cancel/{id}', array('as' => 'AdminCancelRequest', 'uses' => 'AdminController@cancel_requests'));
...
Route::get('admin/create_manual_assign', array('as'=>'create_manual_assign','uses'=>'AdminController@create_manual_assign'));


Route::get('admin/advance_trip', array('as'=>'AdminAdvanceTrip','uses'=>'AdminController@save_advance_trips'));
...
Route::get('/admin/push_noti', array('as' => 'AdminPushNotification', 'uses' => 'AdminController@push_noti'));
